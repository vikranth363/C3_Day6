...
var filename = "test_AveragePower";
...
describe(filename, function() {
  ...
  beforeAll(function() {
    ...
    // set up the power measurement values
  ...
  it("should return all measurements when evaluated over the full measurement date span", function() {
    ...
    _.each(self.smartBulbs, function(smartBulb, index) {
      ...
      expectedMeasurements = _.pluck(self.smartBulbMeasurements[measurementSeries.id], "power");
      metricResults = SmartBulb.evalMetric({
        id: smartBulb.id,
        expression: "AveragePower",
